            ...
            >
              <div className="flex flex-col gap-6">
                ...
                <Button
                  variant="outline"
                  onClick={handleThemeToggle}
                  className="flex items-center gap-2 font-bold py-4"
                >
                  {resolvedTheme === "dark" ? (
                    <>
          ...
          {[...Array(4)].map((_, i) => (
            <div key={i} className="flex items-center gap-12 px-6">
              {[
                ...
                <div
                  key={idx}
                  className="flex items-center gap-12 text-white text-3xl font-black uppercase tracking-tighter italic"
                >
                  {text}{" "}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-20 text-center lg:text-left">
            ...
            <h3 className="text-4xl md:text-7xl font-black tracking-tighter">
              Everything you need <br /> to run a city.
            </h3>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
            ...
            {["Product", "Community", "Resources"].map((title) => (
              <div key={title}>
                <h5 className="font-black uppercase tracking-widest text-emerald-500 text-xs mb-6">
                  {title}
                </h5>
