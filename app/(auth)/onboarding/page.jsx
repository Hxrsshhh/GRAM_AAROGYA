...
const App = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-white dark:bg-slate-950 text-slate-900 dark:text-white overflow-x-hidden font-sans flex flex-col">
      ...
      <nav className="shrink-0 z-50 p-4 md:p-8">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-base md:text-lg font-black tracking-tight uppercase text-slate-900 dark:text-white">
              Onboarding
            </span>
          </div>
          ...
          <Button
            ...
            onClick={handleSkip}
            disabled={isSkipping}
            className="h-10 md:h-12 px-4 md:w-42 text-sm"
          >
            {isSkipping ? (
        ...
        <div className="w-full max-w-xl">
          ...
          <AnimatePresence mode="wait">
            <fm.div
              ...
              className="bg-white dark:bg-slate-900/50 backdrop-blur-xl border border-slate-200 dark:border-slate-800 p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem] shadow-2xl shadow-emerald-500/5"
            >
              {/* Step 1: Profile */}
              {step === 1 && (
                <div className="space-y-6">
                  <div className="text-center mb-6">
                    <div className="relative inline-block group mb-4">
                      ...
                      <div
                        ...
                        className="w-20 h-20 md:w-24 md:h-24 rounded-[1.5rem] md:rounded-[2rem] bg-slate-100 dark:bg-slate-800 flex items-center justify-center border-2 border-dashed border-slate-300 dark:border-slate-700 group-hover:border-emerald-500 transition-colors overflow-hidden cursor-pointer relative"
                      >
                        {isUploading ? (
                      ...
                      {!isUploading && (
                        <div className="absolute -bottom-1 -right-1 w-7 h-7 md:w-8 md:h-8 bg-emerald-600 rounded-xl flex items-center justify-center text-white shadow-lg shadow-emerald-600/20 pointer-events-none">
                          <Plus size={14} />
                        </div>
                      )}
                    </div>
                  ...
                  <div className="mb-2">
                    <label className="block text-[10px] md:text-xs font-black uppercase tracking-[0.2em] text-slate-400 mb-2 ml-1">
                      Bio (Optional)
                    </label>
                    <textarea
                      placeholder="Tell us about your community interests..."
                      className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 outline-none focus:border-emerald-500/50 focus:ring-4 focus:ring-emerald-500/5 transition-all font-medium text-slate-900 dark:text-white h-24 resize-none text-sm md:text-base"
                      value={formData.bio}
                      onChange={(e) =>
              ...
              {step === 2 && (
                <div className="space-y-6">
                  ...
                  <div className="p-4 rounded-2xl bg-emerald-500/5 border border-emerald-500/10 flex items-start gap-3">
                    ...
                    />
                    <p className="text-[11px] md:text-xs text-emerald-700 dark:text-emerald-400 font-medium leading-relaxed">
              ...
              {step === 3 && (
                <div className="space-y-6">
                  ...
                  />
                  <div className="text-center p-6 md:p-8 bg-slate-50 dark:bg-slate-900/50 rounded-3xl border border-slate-100 dark:border-slate-800/50">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-emerald-500/10 text-emerald-600 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <div className="flex gap-3 md:gap-4 mt-8">
                {step > 1 && (
                  <button
                    ...
                    className="p-3 md:p-4 rounded-2xl border border-slate-200 dark:border-slate-800 text-slate-500 hover:border-emerald-500 hover:text-emerald-500 transition-all disabled:opacity-50"
                  >
                    <ArrowLeft size={20} />
                  </button>
                )}
      ...
      <footer className="shrink-0 pb-6 md:pb-8 text-center px-6">
        <p className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] md:tracking-[0.4em] text-slate-400 dark:text-slate-600 max-w-xs md:max-w-sm mx-auto leading-relaxed">
