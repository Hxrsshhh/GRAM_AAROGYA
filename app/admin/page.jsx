        ...
        <main className="flex-1 p-6 md:p-10 max-w-7xl mx-auto w-full">
          ...
          <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
            <div>
              <h1 className="text-4xl font-black italic tracking-tight">
                System{" "}
                <span className="text-emerald-500 not-italic">Intel.</span>
              </h1>
              <p className="text-xs font-black uppercase tracking-[0.2em] text-slate-500 mt-1">
                Admin Control Environment v4.0
              </p>
            </div>
            <div className="flex items-center gap-3">
              <div className="relative hidden sm:block">
                ...
                />
                <input
                  className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl py-2 pl-10 pr-4 outline-none focus:border-emerald-500 transition-all text-sm w-64"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            ...
            <StatCard
              index={2}
              title="Resolved"
              value={MOCK_STATS.resolvedReports}
              change="15.3%"
              isPositive
              icon={CheckCircle2}
            ...
            <StatCard
              index={3}
              title="Avg Response"
              value={`${MOCK_STATS.avgResponseTime}d`}
              change="0.4d"
              isPositive={false}
              icon={Clock}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
            ...
            <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-8 flex flex-col">
              <h2 className="text-xl font-black italic mb-8">
                Incident{" "}
