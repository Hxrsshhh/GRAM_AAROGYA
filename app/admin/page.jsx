...
export default function AdminDashboard() {
  ...
  return (
      ...
      <div className="relative z-10 flex flex-col lg:flex-row">
        <main className="flex-1 p-4 md:p-10 max-w-7xl mx-auto w-full pb-24 lg:pb-10 overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-10">
            <div className="lg:col-span-2 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-[1.5rem] md:rounded-[2.5rem] p-5 md:p-8">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                ...
                <div className="flex gap-4">
                  <div className="flex items-center gap-2 text-[9px] md:text-[10px] font-black uppercase">
            ...
            <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-[1.5rem] md:rounded-[2.5rem] p-5 md:p-8 flex flex-col">
              <h2 className="text-lg md:text-xl font-black italic mb-6 md:mb-8">
                Incident{" "}
                <span className="text-emerald-500 not-italic">Domains</span>
              </h2>
              <div className="flex-1 h-50 md:h-62.5">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
    ...
    ::-webkit-scrollbar {
      width: 6px;
      height: 0px; /* Hide horizontal scrollbar specifically */
    }
