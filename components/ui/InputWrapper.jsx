...
export const InputWrapper = ({ label, children, icon: Icon }) => (
  <div className="space-y-1.5 w-full">
    ...
    <div className="relative group">
      {children}
      <div className="absolute inset-0 border border-slate-200 dark:border-slate-700/50 rounded-xl pointer-events-none group-focus-within:border-blue-500/50 transition-colors" />
    </div>
  </div>
);
