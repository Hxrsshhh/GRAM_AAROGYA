...
export default function Footer() {
  return (
    <footer className="relative border-t border-neutral-200 dark:border-white/5 bg-white dark:bg-[#030303]/50 transition-colors duration-300">
      {/* Subtle Top Glow */}
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
          ...
          <div className="flex flex-col items-start space-y-6">
            <Link href="/" className="flex items-center gap-2 group">
              <div className="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-2xl border border-blue-500/20 bg-blue-500/10 transition-all duration-500 group-hover:bg-blue-500 group-hover:rotate-10">
            ...
            <div className="flex items-center gap-4">
              {[
                { icon: Github, href: "https://github.com/Hxrsshhh" },
                {
                  icon: Linkedin,
                  href: "https://www.linkedin.com/in/hxrsshhh/",
                },
                { icon: Twitter, href: "#" },
              ].map((social, i) => (
                <Link
