    ...
    <>
      ...
      >
        <div className="max-w-[86rem] mx-auto px-6 lg:px-12 flex items-center justify-between">
          ...
          {/* Center: Desktop Navigation (Hidden on LG and below) */}
          ...
          <div className="flex items-center gap-3 relative z-110">
            {/* Desktop-Only Items: Hidden when menu button is visible (lg:flex) */}
      ...
      >
        <div className="flex flex-col h-full pt-24 pb-8 px-6 overflow-y-auto">
                ...
                {navLinks.map((link) => (
                  <Link href={`${link.path}`} key={link.label}>
                    <button
                      ...
                      className="w-full flex items-center justify-between p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800"
                    >
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 gap-2">
                {userMenuItems.map((item) => (
                  <Link href={`${item.path}`} key={item.label}>
                    <button
                      className="w-full flex items-center gap-4 p-4 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors"
                    >
          ...
          {/* Mobile Footer (Theme toggle moved here) */}
          <div className="mt-auto space-y-4">
           ...
           <Link href='/'>
            <Button
            variant="danger"
              className="w-full py-6 border-red-100 dark:border-red-900/30 text-red-500 bg-red-500/50 hover:red-500/80 rounded-2xl font-bold"
            >
